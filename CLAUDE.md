...
- **Dashboard behavioral fidelity.** The four todo states, the streak grid, CSV export, and day drilldown are the acceptance criteria for any visual refactor — behavior does not change, only appearance. As of 2026-08-22 the visual theme itself is no longer frozen: it was deliberately replaced (see below), and `Dashboard.jsx` was reskinned in place, not rebuilt.
