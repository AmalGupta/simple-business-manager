// record_call tool schema — v3. Same shape as v2; due_date and todos
// descriptions tightened for relative-day resolution and dispatch assignments.
// Never edit a shipped version in place — changes create v4/.
