// record_call tool schema — v7. Adds optional todos[].site so each assignment
// can carry the spoken site; call-level sites[] remains. Never edit a shipped
// version in place — changes create v8/.
        ...
        items: {
          ...
          properties: {
            ...
            site: {
              type: "string",
              description:
                "Site this task is for, matched to the known sites roster when a site was spoken for this assignment. Empty if no site was spoken for this todo. Do not invent. On multi-site dispatch, different todos may carry different sites.",
            },
          },
          required: ["text", "owner"],
        },
