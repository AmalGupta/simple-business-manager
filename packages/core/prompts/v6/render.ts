// Diarized transcript → user message (v6). Unchanged from v5/v4 — v6's fix
// (system.ts: few-shot examples) is prompt-only. Same calendar-day anchoring
// as v3. No more index-based
