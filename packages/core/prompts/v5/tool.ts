// record_call tool schema — v5. Unchanged from v4/v3. v5's only change is in
// system.ts (rule 1 clarified: the "Call with X on Y" preamble line is
// identity/date context, not extractable content — a real eval run caught
// the model pulling a site name from clientName that was never spoken).
