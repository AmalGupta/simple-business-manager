...
export interface NewEscalationInput {
  ...
  source?: EscalationSource;
  installationUpdateId?: string | null;
  /** migration 0041: set when dual-written from a production job's "site problem". */
...
// ---------------------------------------------------------------------------
// Production job tracker — migration 0041. See production-steps.ts for the
// fixed step catalog and migrations/0041_production_warehouse.sql for the
...
// ---------------------------------------------------------------------------
// Warehouse register — migration 0041. A movement ledger, not a stock
