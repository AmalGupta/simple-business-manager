...
export interface Escalation {
  ...
  installation_update_id: string | null;
  /** migration 0042: set when dual-written from a production job's "site problem" — NULL otherwise. */
...
// migrations/0042_production_warehouse.sql for the design rationale.
// ---------------------------------------------------------------------------
